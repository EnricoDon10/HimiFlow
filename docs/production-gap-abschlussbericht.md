...
| 3 Pagination/Filter | `SavingsListDtos`, Savings-API, All-/My-Savings-Komponenten | Serverseitige Filter und begrenzte Seiten (`pageSize` mit Obergrenze) schützen API und UI vor unbounded queries. | `SavingsPaginationTests`, Browser-Abnahme |
